...
const BOLTS_COLLECTION = "lockBolts";

// ✅ Add new bolt
export const addLockBolt = async (data) => {
  try {
...
export const updateLockBolt = async (id, data) => {
  try {
...
export const getLockBoltById = async (id) => {
  try {
    const docRef = doc(db, BOLTS_COLLECTION, id);
...
// ✅ Get all bolts
export const getAllLockBolts = async () => {
  try {
...
// ✅ Delete bolt
export const deleteLockBolt = async (id) => {
  try {
    const docRef = doc(db, BOLTS_COLLECTION, id);
...
export const updateLockBoltQuantity = async (id, selectedQuantity) => {
  try {
